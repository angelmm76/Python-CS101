        ...
        for page in graph:
            ...
            for node in graph:
                if page in graph[node]:
                    if not are_reciprocal(graph, node, page, k):# and not are_reciprocal(graph, node, page):# and node not in graph[page]:
                     newrank = newrank + d * (ranks[node]/len(graph[node]))
            newranks[page] = newrank
        ranks = newranks
    return ranks
    
def are_reciprocal(graph, source, destination, n):
    if n == 0:
        return source == destination
    if source in graph[destination]:
        return True
    for node in graph[destination]:
        if are_reciprocal(graph, source, node, n - 1):
            return True
    return False
...
print are_reciprocal(g, 'a', 'a', 0)
print are_reciprocal(g, 'a', 'b', 0)
print are_reciprocal(g, 'a', 'a', 1)
print are_reciprocal(g, 'a', 'b', 0)
print are_reciprocal(g, 'a', 'b', 1)
print are_reciprocal(g, 'a', 'd', 2)
print are_reciprocal(g, 'a', 'b', 2)
